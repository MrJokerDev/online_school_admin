        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ route('dashboard.index') }}" class="flex ml-2 md:mr-24">
                    <x-application-logo class="block h-9 mr-3 w-auto fill-current text-gray-800 dark:text-gray-200" />
      ...
      <ul class="space-y-2">
         ...
         <li>
            <x-nav-link :href="route('questions.index')" :active="request()->routeIs('questions.index')">
                <span class="flex-1 ml-3 whitespace-nowrap">{{ __('Questions') }}</span>
            </x-nav-link>
         </li>
         <li>
            <x-nav-link :href="route('courses.index')" :active="request()->routeIs('courses.index')">
                <span class="flex-1 ml-3 whitespace-nowrap">{{ __('Courses') }}</span>
            </x-nav-link>
         </li>
         <li>
            <x-nav-link :href="route('lessons.index')" :active="request()->routeIs('lessons.index')">
                <span class="flex-1 ml-3 whitespace-nowrap">{{ __('Lessons') }}</span>
            </x-nav-link>
         </li>
      </ul>
   </div>
